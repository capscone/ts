...
import com.capstone.milkteabooking.api.responseObj.ErrorResponse;
...
import com.capstone.milkteabooking.utilities.Utils;
...
public abstract class BaseActivity extends AppCompatActivity implements BaseContext {
    ...
    public void setPatient(User patient) {
        CoreManager.setUser(this, patient);
    }

    public void clearPatient() {
        CoreManager.clearUser(this);
    }

    public User getPatient() {
        return CoreManager.getUser(this);
    }
